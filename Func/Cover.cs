...
{
    [ECConfiguration("ec.app.stock.func.Cover")]
    public class Cover : GPNode, IEvalPrint
    {
        public override string ToString() { return "cover"; }
        ...
        public void EvalPrint(
            ...
            IProblem problem)
        {
            ((IEvalPrint)Children[0]).EvalPrint(state, thread, input, stack, individual, problem);
        }
    }
}